...
- `$ rpm remote --token <token> <user>` - to save remotes & GitHub access token for cpm
- `$ rpm search [repo]` - to serch repository on regiested user's github, shows branches & tags
