...
const cloneGithub = (url, clonePath, ownerRepo, options) => {
  ...
  if(repositoryMapping[ownerRepo].isTag) {
    ...
    cloneOpts.checkoutBranch = versionRange;
    Git.Clone(url, clonePath, cloneOpts).done(repository => {
